export default function ProductCard({ name, image, price }) {
    return (
        <article className='max-w-80 sm:max-w-48 text-sm flex flex-col gap-1 items-center p-2 cursor-pointer animate-fadeInUp opacity-0 transition-shadow duration-200 hover:shadow-lg'>
